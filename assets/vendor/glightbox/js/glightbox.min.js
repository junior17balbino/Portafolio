!function(e, t) {
    ...
    function o() {
        ...
        for (var s = function(i) {
            for (var n in i)
                Object.prototype.hasOwnProperty.call(i, n) && (t && "[object Object]" === Object.prototype.toString.call(i[n]) ? e[n] = o(!0, e[n], i[n]) : e[n] = i[n])
        }; i < n; i++) {
            var l = arguments[i];
            s(l)
        }
    ...
    function r(e, t) {
        if ((E(e) || e === window || e === document) && (e = [e]),
        L(e) || I(e) || (e = [e]),
        0 != M(e))
            if (L(e) && !I(e))
    ...
    var q = i((function t(i, n) {
        ...
        value: function(e) {
            if (this.slide.classList.contains("zoomed"))
                ...
                e.target.classList.contains("nodrag") || g(e.target, ".nodrag") || -1 !== ["input", "select", "textarea", "button", "a"].indexOf(t) ? this.active = !1 : (e.preventDefault(),
                (e.target === this.el || "img" !== t && g(e.target, ".gslide-inline")) && (this.active = !0,
    ...
    function _(e, t, i, n) {
        ...
        w(this.settings.plyr.js, "Plyr", (function() {
            ...
            !u && (c.match(/(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/) || c.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/) || c.match(/(youtube\.com|youtube-nocookie\.com)\/embed\/([a-zA-Z0-9\-_]+)/) || c.match(/(youtube\.com|youtube-nocookie\.com)\/shorts\/([a-zA-Z0-9\-_]+)/)) && (u = "youtube"),
            "local" === u || !u) {
                u = "local";
                var l = '<video id="' + o + '" ';
    ...
    function B(e, t, i, n) {
        ...
        if (a && (k(a) && (s = y('<div class="ginlined-content">'.concat(a, "</div>"))),
        E(a))) {
    ...
    var j = i((function t() {
        ...
        value: function() {
            ...
            "" == s.title && "" == s.description ? g && g.parentNode.parentNode.removeChild(g.parentNode) : (h && "" !== s.title ? (h.id = f,
            ...
            "video" !== o) {
                if ("external" !== o)
                    return "inline" === o ? (B.apply(this.instance, [t, s, this.index, v]),
                ...
                _.apply(this.instance, [t, s, this.index, v])
        }
    }, {
        key: "slideShortDesc",
        value: function(e) {
            ...
            h("click", {
                ...
                withCallback: function(e, n) {
                    ...
                    var o = h("click", {
                        ...
                        withCallback: function(e, n) {
                            "a" !== e.target.nodeName.toLowerCase() && (c(s, "gdesc-open"),
                            d(s, "gdesc-closed"),
        ...
        value: function(e) {
            if (e.touches) {
                ...
                i > 1) {
                    ...
                    null !== t.x && (this.pinchStartLen > 0 && (e.zoom = F(r) / this.pinchStartLen,
    ...
    var K = T()
        ...
        value: function() {
            ...
            d(this.nextButton, "glightbox-button-hidden")) : (c(this.prevButton, "glightbox-button-hidden"),
        ...
        value: function(e) {
            ...
            this.elements.length && (r(this.elements, (function() {
        ...
        value: function() {
            ...
            if ((e = e || this.activeSlide) && !u(e, "zoomed")) {
                var t = x()
                    ...
                    , l = t.width
                    , o = t.height;
                if (l <= 768 ? d(document.body, "glightbox-mobile") : c(document.body, "glightbox-mobile"),
                i || n) {
                    var r = !1;
                    if (s && (u(s, "description-bottom") || u(s, "description-top")) && !u(s, "gabsolute") && (r = !0),
                    n)
                        if (l <= 768)
                            n.querySelector("img");
                        else if (r) {
